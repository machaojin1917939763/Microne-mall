...
public class PersonalController {
    ...
    public Result login(@RequestParam("loginName") String loginName,
        ...
        String loginResult = MicroneMallUserService.login(loginName, MD5Util.MD5Encode(password, "UTF-8"), httpSession);
        //登录成功
    ...
    public Result register(@RequestParam("loginName") String loginName,
        ...
        String registerResult = MicroneMallUserService.register(loginName, password);
        //注册成功
    ...
    public Result updateInfo(@RequestBody MallUser mallUser, HttpSession httpSession) {
        MicroneMallUserVO mallUserTemp = MicroneMallUserService.updateUserInfo(mallUser, httpSession);
